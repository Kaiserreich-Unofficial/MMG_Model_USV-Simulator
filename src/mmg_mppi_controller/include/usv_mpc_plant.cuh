...
template <typename DYN_T, typename CONTROLLER_T>
class GenericUSVMPCPlant : public BasePlant<CONTROLLER_T>
{
public:
  ...
  GenericUSVMPCPlant(std::shared_ptr<CONTROLLER_T> controller, int hz, int optimization_stride)
